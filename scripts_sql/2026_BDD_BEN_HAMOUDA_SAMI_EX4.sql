...
-- Je regroupe les défis validés et pas valides
-- ============================================================
...
-- j'utilise HAVING pour filtrer apres le GROUP BY.
-- ================================================
...
-- EXTRACT(EPOCH FROM interval) permet de convertir la duree en secondes. On divise par 3600 pour obtenir des heures.
...
-- ================================================================================================
-- 5. Streamers ayant effectivement lance au moins un stream avec le titre de leur session et l'heure de debut.
-- ================================================================================================
